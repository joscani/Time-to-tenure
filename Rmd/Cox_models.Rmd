...
```
En España, para la disciplina de ciencias sociales el riesgo de conseguir la plaza es 1.53 veces mayor para los que no se mueven que para los que se mueven
...
```
El anova nos dice que no sería necesaria la interacción entre movilidad y país. 

```{r}
summary(mod.noitaly2)
```
Se tiene que el hazard ratio es 1.26 veces mayor para los que no se mueven.. Estos resultados están en línea con los obtenidos anteriormente
